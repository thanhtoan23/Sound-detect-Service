...
\begin{itemize}
    ...
    \item Thiết kế hệ thống: Mô tả kiến trúc pipeline với bốn thành phần chính - thu thập âm thanh (VAD, DOA), xử lý tín hiệu (bandpass filter, spectral gating), phân loại AI (CNN), và giao diện (GUI/CLI).
