...
Hàm truyền đạt (Transfer Function) tổng quát của một bộ lọc thông dải bậc hai trong miền Laplace ($s$) có dạng:
\begin{equation}
    H_{BP}(s) = \frac{K \left(\frac{\omega_0}{Q}\right) s}{s^2 + \left(\frac{\omega_0}{Q}\right) s + \omega_0^2}
\end{equation}
Trong đó $\omega_0 = 2\pi f_0$ là tần số góc trung tâm.
...
\begin{itemize}
    ...
    \item Phân bố cực: Các cực (poles) của hàm truyền đạt $H(s)$ nằm đều nhau trên nửa mặt phẳng trái của vòng tròn đơn vị trong mặt phẳng phức $s$.
\end{itemize}
